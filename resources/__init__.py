...
def create_or_update_resource(**kwargs):
    ...
    Arguments:
        ...
        kwargs["resource_type"]: The type of resource, e.g tender.
    """
    try:
...
def before_request():
    ...
    if request.endpoint in ["tenderListAPI", "tenderapi"]:
...
class Index(Resource):
    ...
    def get(self):
        ...
        return {"message": "Welcome to the Team-279-Backend-develop API."}
