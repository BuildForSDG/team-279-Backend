...
from src import db, app, login_manager, ma
...
class Company(db.Model):
    ...
    companyRegistrationNo = db.Column(db.String(50), nullable=False, unique=True)
    directors = db.Column(db.String(60), nullable=False)
    company_phone_number = db.Column(db.String(15), nullable=False, unique=True)
